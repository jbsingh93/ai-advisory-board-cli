...
>
> **Status (2026-06-15):** code complete — typecheck + build clean, 344 unit tests pass (incl. 15 new). **Live smoke still owed** (LLM-behavioural; must run from the external test folder per `CLAUDE.md`).
