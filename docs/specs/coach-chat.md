# `docs/specs/coach-chat.md` — Decision Coach: chat happy path

**Phase:** 2 (Decision Coach)
**Surface:** `data-testid="tab-coach"` sidebar → `coach-view` route.
**Endpoints:**
...
## Steps
1. Click **Coach** (`data-testid="tab-coach"`) in the sidebar.
