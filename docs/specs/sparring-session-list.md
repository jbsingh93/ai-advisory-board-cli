# `docs/specs/sparring-session-list.md` — Sparring: per-discussion session list
...
## Pre-conditions
- At least 3 sparring sessions on the same discussion (run `docs/specs/sparring-anchor-deepdive.md` three times: same discussion, three different members or three different (round, turn) anchors).
