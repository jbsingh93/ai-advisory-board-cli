# `specs/sparring-inject-back.md` — Sparring: inject insight back into the main timeline
...
## Pre-conditions
- Sparring session with at least one assistant reply (run `specs/sparring-anchor-deepdive.md` first).
